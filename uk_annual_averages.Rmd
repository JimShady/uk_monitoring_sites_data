...
```{r}
london    <- st_read('https://github.com/KCL-ERG/useful_geography/raw/master/london_boroughs.geojson')

ggplot() + 
  geom_sf(data=london) +
  geom_sf(data = filter(result, pollutant %in% c('pm10', 'pm25', 'no2') & capture_rate > 70 & duplicate == 'N'),
          aes(size = mean)) +
